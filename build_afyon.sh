...
# Build Variables
export version=ZERO_Cyanogenmod
export TOOLCHAIN=/home/dm47021/Android/toolchains/arm-eabi-4.8/bin/arm-eabi-
...
rm -rf zfiles/packaging/system/lib/modules/pronto/wlan.ko
...
${txtrst}" 
cp cm_afyonlte_defconfig .config
...
cp zfiles/packaging/system/lib/modules/wlan.ko zfiles/packaging/system/lib/modules/pronto/wlan.ko
rm -rf zfiles/packaging/system/lib/modules/wlan.ko
